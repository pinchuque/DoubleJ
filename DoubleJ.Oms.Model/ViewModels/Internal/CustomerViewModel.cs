...
namespace DoubleJ.Oms.Model.ViewModels.Internal
{
    public class CustomerViewModel
    {
        ...
        public CustomerViewModel(Customer customer, IEnumerable<CustomerProductItem> productData)
            : this()
        {
            ...
            TrayLabel = string.IsNullOrEmpty(customer.TrayLabel) ? "tray.lbl" : customer.TrayLabel;
            CustomerLocations = customer.CustomerLocation.Select(x => new CustomerLocationViewModel(x)).ToList();
            IsArchive = customer.IsArchived;
            ...
            Id = customer.Id;
            CustomerProductCodeList = productData;
        }
