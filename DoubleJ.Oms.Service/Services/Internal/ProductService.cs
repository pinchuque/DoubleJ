...
namespace DoubleJ.Oms.Service.Services.Internal
{
    public class ProductService : IProductService
    {
        ...
        {
           // productViewModel.BoxTypeNames = new SelectList(GetBoxTypes(productViewModel.CustomerType), "TypeId", "TypeName");
            //productViewModel.BagTypeNames = new SelectList(GetBagTypes(productViewModel.CustomerType), "TypeId", "TypeName");
        }
        ...
        public void Add(ProductViewModel model)
        {
            var product = new Product
            {
                ...
                BoxSizeId = model.BoxTypeId.GetValueOrDefault(),
                BagSizeId = model.BagTypeId.GetValueOrDefault(),
        ...
        public void Edit(ProductViewModel model)
        {
            ...
            product.BoxSizeId = model.BoxTypeId.GetValueOrDefault();
            product.BagSizeId = model.BagTypeId.GetValueOrDefault();
        ...
        {
            return string.Format("{1} {0}", product.Upc, product.EnglishDescription);
        }

        public IEnumerable<ProductTypeItem> GetBoxTypes(OmsCustomerType? customerTypeId, bool isBoth)
        {
            return GetCases(2,customerTypeId, isBoth);
        }
        public IEnumerable<ProductTypeItem> GetBagTypes(OmsCustomerType? customerTypeId, bool isBoth)
        {
            return GetCases(1, customerTypeId, isBoth);
        }
