...
{
    internal class LabelOutputViewModel
    {
        public int OrderDetailId { get; set; }
        public OmsLabelType Type { get; set; }
        ...
        public string BornInRegionName { get; set; }
        public string RaisedInRegionName { get; set; }
        public string ProductOfRegionName { get; set; }
        public string SlaughteredInRegionName { get; set; }
        ...
        [DisplayName("Owner Product Code")]
        ...
        public string VarCustomerProductValue { get; set; }
