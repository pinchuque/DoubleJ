...
namespace DoubleJ.Oms.LabelManager
{
    ...
    public partial class LabelManagerWindow
    {
        ...
        private ICustomerProductDataRepository _customerProductDataRepository;
        ...
        public LabelManagerWindow()
        {
            ...
            GridTray.OnProductChanged += UnitProductChanged;
            GridCustomBoxes.OnCustomerLocationChanged += CustomerLocationChanged;
            GridCustomBoxes.OnButtonEditClicked += CustomCustomerEditBox;
            GridCustomTray.OnCustomerLocationChanged += CustomerLocationChanged;
            GridCustomTray.OnButtonEditClicked += CustomCustomerEditBox;
        ...
        {
            _labelTypeMode = _activeLabelType == OmsLabelType.Box ? LabelTypeMode.CustomBoxLabel: LabelTypeMode.CustomTrayLabel;
